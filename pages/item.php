          ...
          <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <?php
                    ...
                    try{
                        ...
                        $sql = $conn->query('SELECT cat_id, category_name from categories')->fetchAll(PDO::FETCH_KEY_PAIR);  
                    }
                        
                        catch(PDOException $e){
                              echo "<span style=\"color: white; display : block; text-align:center; font-size:18px; font-weight:bolder\">conennction faile or data already exist". $e->getMessage().  "</span>";
                        }
            ?>
                    ...
                    <?php
                      ...
                      if ( $_SERVER['REQUEST_METHOD'] == "POST"){
                        ...
                        try{
                            ...
                            $conn = new PDO("mysql:host=$servername;dbname=$dbname",$username,$password);
                            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                            $sql = "INSERT INTO items (item_name, item_price, description , stock) 
                                    values ('$itemname',$price,'$description',$stock)";
                            $conn->exec($sql);
                            echo "<span style=\"color: white; display : block; text-align:center; font-size:18px; font-weight:bolder\">Item added successfully</span>";   
                      }
                      catch(PDOException $e){
